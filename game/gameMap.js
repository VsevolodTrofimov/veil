var game = {
    ...
    "blame": {
        text: ["Если тебя обвиняют в том, что ты \"троллишь\", прежде всего попытайся разобраться",
			...
			"",
			"И небольшой совет: если обидчик преследует тебя в личных сообщениях или",
			"хулиганит в комментариях, тебе стоит пожаловаться на его страницу."],
		actions: [{
			text: 'Посмотреть, как это можно сделать, можно <a href="https://vk.com/faq8667">по ссылке.</a>'
		}]
    }
};
