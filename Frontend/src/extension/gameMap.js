var game = {
    ...
    "yes_ofc": {
        text: ["Правильно!",
            "Как и отбирание денег и вещей, пинки и толчки, как и предвзятое отношение на основе национальности или пола"],
        actions: [{
    ...
    "violence": {
        text: ["Вообще насилием можно считать любое умышленное действие, которое может нанести физическую или психологическую травму, покалечить и даже убить",
    ...
    "cyber_1": {
        text: ["Правильно",
	    "К сожалению, столкнуться с насилием можно и в интернете",
            "Для психологического насилия в сети есть слово \"кибербуллинг\""],
        actions: [{
    ...
    "stat": {
        text: ["По исследованиям, интернет-травле подвергается каждый четвёртый подросток",
            "Что самое страшное: многие из них, столкнувшись с травлей, думали о самоубийстве"],
        actions: [{
    ...
    "watdo": {
        text: ["Если тебе кажется, что ты подвергся травле, сделай следующее:",
            "Во-первых, набери воздуха в грудь и сосчитай до 10, это поможет тебе успокоиться",
            "Во-вторых, поговори об этом с близким тебе человеком",
            "Наконец, не надо мстить, ругаться и волноваться, потому что хулиган по ту сторону экрана дожидается именно такой реакции от тебя"],
        actions: [{
            text: "Звучит разумно",
            goto: "blame"
        }]
    ...
    "me": {
        text: ["Даже если с тобой такого не случается, никто из твоих друзей от этого не застрахован",
            "Прежде всего - не смейся над другом, когда он обратится к тебе с подобной проблемой",
    ...
    "blame": {
        ...
        "Постарайся понять, не задел ли ты чьи-нибудь чувства",
	"Не стесняйся просить прощения за нанесённую обиду - это улучшит отношения между тобой и собеседником",
	...
	"И небольшой совет напоследок: если обидчик преследует тебя в личных сообщениях или хулиганит в комментариях, тебе стоит пожаловаться на его страницу"],
		actions: [{
			text: '<a href="https://vk.com/faq8667" style="color:white;">Посмотреть, как</a>'
		}]
    }
};
